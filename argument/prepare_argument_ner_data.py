...
def convert(input_path, output_path):
    ...
    for item in data:
        ...
        if "B-ARG" in result["labels"]:  # 跳过找不到 argument 的样本
...
if __name__ == "__main__":
    convert("/root/nlp-new/data/split_data/argument_data.json", "ner_data/argument_ner_train.jsonl")
